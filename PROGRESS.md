...
## Last completed: Buyer cart synchronization + single editable address (2026-09-01, #603–#610, live in prod)
## Status: released and verified in production, including both DB migrations. Tracker: `docs/buyer-cart-sync-and-single-address.md`.
