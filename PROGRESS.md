...
## Current Phase: SEO / city-first URL refactor (2026-06-06, 7 phases; #283–#288 merged to develop, release pending)
## Last completed: Wishlist (Favorites) completion & hardening (2026-06-05, #272–#280)
## Status: buyer-web city-first URLs (`/{ville}/{slug}-{shortCode}`, city-scoped categories), clean slug + `Product.shortCode` resolver + `City.slug`, French storefront routes (panier/paiement/commandes/favoris) with 301/308s, de-blocked crawlable homepage, city-aware sitemap/canonical/JSON-LD. Mobile + analytics untouched by design. Authoritative: `docs/url-and-seo-strategy.md`.
