/**
 * Browser security headers for the admin portal (D4, 2026-09-06).
 *
 ...
 * Cloudinary images (+ the signed private-download host used for seller documents),
...
export interface PortalSecurityOptions {
  ...
  apiUrl?: string;
  /** `NEXT_PUBLIC_SENTRY_DSN_ADMIN_WEB`; empty ⇒ no Sentry origin allowed. */
  sentryDsn?: string;
...
export const CLOUDINARY_IMG_HOSTS = ['https://res.cloudinary.com', 'https://api.cloudinary.com'];
