...
///
/// Unlike the API and the three web apps, the Flutter apps never put request
/// bodies, cookies or auth headers into a Sentry event: there is no
/// `sentry_dio` / `SentryHttpClient` integration, `LogInterceptor` runs with
/// every header and body flag off, and `Sentry.setUser` carries only an id and
/// a role. So this is not the API's problem restated — it is the narrower one
/// of user input reaching a field the app writes itself.
///
/// ## MS6 (2026-09-09)
///
