...
import { SellerBadge } from '@/components/product/seller-badge';
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 lg:gap-10">
            ...
            <div>
              ...
              {/* Trust signals — reassurance in the buy box. COD-only platform,
                  local delivery; the « Vendeur vérifié » row appears only when
                  the API says so (seller.verified), never as static copy. */}
