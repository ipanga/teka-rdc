 ...
 *
 * Used as posthog-js `before_send`. Phone numbers (+243XXXXXXXXX) are
 * delivery/contact identifiers (Rule 13 in CLAUDE.md) — strip them from every
 ...
 *
 * Mirrors apps/seller-web/sentry-scrub.ts:scrubPhones — keep the regex in sync
