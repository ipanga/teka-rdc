...
export class CreateDeliveryZoneDto {
  ...
  @IsString({ message: 'Les frais en CDF doivent être une chaîne de caractères (nombre entier)' })
  @IsNotEmpty({ message: 'Les frais en CDF sont requis' })
  @Matches(/^\d+$/, { message: 'Les frais en CDF doivent contenir uniquement des chiffres' })
  feeCDF: string;

  @IsOptional()
  @IsString({ message: 'Les frais en USD doivent être une chaîne de caractères (nombre entier)' })
  @Matches(/^\d+$/, { message: 'Les frais en USD doivent contenir uniquement des chiffres' })
  feeUSD?: string;
