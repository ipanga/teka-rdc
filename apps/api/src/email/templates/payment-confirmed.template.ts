    ...
    <tr>
      <td align="center">
        <table role="presentation" cellpadding="0" cellspacing="0" style="max-width:560px;width:100%;background:#ffffff;border-radius:8px;padding:40px;">
          <tr>
            <td>
              <h1 style="margin:0 0 16px 0;font-size:22px;color:#111827;">Paiement confirmé</h1>
              ...
              <table role="presentation" cellpadding="0" cellspacing="0" width="100%" style="margin:0 0 24px 0;background:#f9fafb;border-radius:6px;padding:16px;">
                <tr>
                  <td style="color:#6b7280;font-size:14px;">Montant réglé</td>
                  <td align="right" style="color:#111827;font-size:14px;font-weight:600;">${amountCDF} FC</td>
                </tr>
              </table>
              <table role="presentation" cellpadding="0" cellspacing="0" style="margin:0 0 24px 0;">
                <tr>
                  <td style="border-radius:6px;background:#BF0000;">
                    <a href="${orderUrl}" style="display:inline-block;padding:12px 24px;color:#ffffff;text-decoration:none;font-weight:600;">Voir le reçu</a>
                  </td>
                </tr>
              </table>
              <p style="margin:0;color:#6b7280;font-size:13px;line-height:1.6;">
                Ce reçu fait foi. Vous pouvez le retrouver à tout moment dans l'historique de vos commandes.
              </p>
            </td>
          </tr>
        </table>
