export function payoutRejectedTemplate(
...
<head>
  <meta charset="UTF-8">
  <title>Demande de retrait refusée — Teka RDC</title>
</head>
    ...
    <tr>
      <td align="center">
        <table role="presentation" cellpadding="0" cellspacing="0" style="max-width:560px;width:100%;background:#ffffff;border-radius:8px;padding:40px;">
          <tr>
            <td>
              <h1 style="margin:0 0 16px 0;font-size:22px;color:#111827;">Demande de retrait refusée</h1>
              <p style="margin:0 0 16px 0;color:#374151;line-height:1.6;">${greeting}</p>
              <p style="margin:0 0 16px 0;color:#374151;line-height:1.6;">
                Votre demande de retrait de <strong>${amountLabel}</strong> n'a pas été approuvée. Le montant a été recrédité sur votre solde Teka RDC.
              </p>
