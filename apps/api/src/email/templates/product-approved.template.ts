...
<head>
  <meta charset="UTF-8">
  <title>Votre produit a été approuvé — Teka RDC</title>
</head>
    ...
    <tr>
      <td align="center">
        <table role="presentation" cellpadding="0" cellspacing="0" style="max-width:560px;width:100%;background:#ffffff;border-radius:8px;padding:40px;">
          <tr>
            <td>
              <h1 style="margin:0 0 16px 0;font-size:22px;color:#111827;">Votre produit a été approuvé 🎉</h1>
              <p style="margin:0 0 16px 0;color:#374151;line-height:1.6;">${greeting}</p>
              <p style="margin:0 0 24px 0;color:#374151;line-height:1.6;">
                Bonne nouvelle : le produit <strong>«&nbsp;${productName}&nbsp;»</strong> a été approuvé et est maintenant visible aux acheteurs sur Teka RDC.
              </p>
              <table role="presentation" cellpadding="0" cellspacing="0" style="margin:0 0 24px 0;">
                <tr>
                  <td style="border-radius:6px;background:#BF0000;">
                    <a href="${dashboardUrl}" style="display:inline-block;padding:12px 24px;color:#ffffff;text-decoration:none;font-weight:600;">Voir mes produits</a>
                  </td>
                </tr>
              </table>
