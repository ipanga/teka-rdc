export function buyerClaimTemplate(
  claimUrl: string,
  expiryHours: number,
): string {
  return `<!DOCTYPE html>
...
<head>
  <meta charset="UTF-8">
  <title>Réclamez votre compte Teka RDC</title>
</head>
    ...
    <tr>
      <td align="center">
        <table role="presentation" cellpadding="0" cellspacing="0" style="max-width:560px;width:100%;background:#ffffff;border-radius:8px;padding:40px;">
          <tr>
            <td>
              <h1 style="margin:0 0 16px 0;font-size:22px;color:#111827;">Réclamez votre compte Teka RDC</h1>
              <p style="margin:0 0 16px 0;color:#374151;line-height:1.6;">
                Teka RDC utilise désormais WhatsApp pour la connexion des acheteurs. Pour conserver votre compte et continuer à utiliser nos services, cliquez sur le bouton ci-dessous pour associer votre numéro WhatsApp.
              </p>
              ...
              <table role="presentation" cellpadding="0" cellspacing="0" style="margin:0 0 24px 0;">
                <tr>
                  <td style="border-radius:6px;background:#BF0000;">
                    <a href="${claimUrl}" style="display:inline-block;padding:12px 24px;color:#ffffff;text-decoration:none;font-weight:600;">Associer mon WhatsApp</a>
                  </td>
                </tr>
              </table>
              ...
              <p style="margin:0 0 24px 0;color:#6b7280;font-size:13px;word-break:break-all;">
                <a href="${claimUrl}" style="color:#BF0000;">${claimUrl}</a>
              </p>
              <p style="margin:0;color:#6b7280;font-size:13px;line-height:1.6;">
                Si vous n'êtes pas à l'origine de cette demande, ignorez cet email — aucune action ne sera effectuée tant que vous n'aurez pas cliqué sur le lien et vérifié un code WhatsApp.
              </p>
            </td>
          </tr>
        </table>
