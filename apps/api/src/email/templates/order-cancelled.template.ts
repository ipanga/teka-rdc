export function orderCancelledTemplate(
  ...
  const reasonBlock = reason
    ? `<p style="margin:0 0 16px 0;color:#374151;line-height:1.6;">Motif communiqué : <em>${reason}</em></p>`
    : '';
    ...
    <tr>
      <td align="center">
        <table role="presentation" cellpadding="0" cellspacing="0" style="max-width:560px;width:100%;background:#ffffff;border-radius:8px;padding:40px;">
          <tr>
            <td>
              <h1 style="margin:0 0 16px 0;font-size:22px;color:#111827;">Commande annulée</h1>
              ...
              <p style="margin:0 0 24px 0;color:#374151;line-height:1.6;">
                Aucun paiement n'a été prélevé. Si un règlement avait été initié, il sera automatiquement remboursé.
              </p>
              <table role="presentation" cellpadding="0" cellspacing="0" style="margin:0 0 24px 0;">
                <tr>
                  <td style="border-radius:6px;background:#BF0000;">
                    <a href="${orderUrl}" style="display:inline-block;padding:12px 24px;color:#ffffff;text-decoration:none;font-weight:600;">Voir le détail</a>
                  </td>
                </tr>
              </table>
              <p style="margin:0;color:#6b7280;font-size:13px;line-height:1.6;">
                Une question ? Répondez à cet email ou contactez le support depuis votre espace Teka RDC.
              </p>
            </td>
          </tr>
        </table>
