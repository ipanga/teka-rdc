export function buyerSetupTemplate(
  setupUrl: string,
  expiryHours: number,
): string {
  return `<!DOCTYPE html>
...
<head>
  <meta charset="UTF-8">
  <title>Configurez votre compte Teka RDC</title>
</head>
    ...
    <tr>
      <td align="center">
        <table role="presentation" cellpadding="0" cellspacing="0" style="max-width:560px;width:100%;background:#ffffff;border-radius:8px;padding:40px;">
          <tr>
            <td>
              <h1 style="margin:0 0 16px 0;font-size:22px;color:#111827;">Configurez votre compte Teka RDC</h1>
              <p style="margin:0 0 16px 0;color:#374151;line-height:1.6;">
                Teka RDC est passé à la connexion par email et mot de passe. Pour continuer à utiliser votre compte, veuillez définir un mot de passe en cliquant sur le bouton ci-dessous.
              </p>
              ...
              <p style="margin:0;color:#6b7280;font-size:13px;line-height:1.6;">
                Si vous n'êtes pas inscrit sur Teka RDC, ignorez cet email — votre compte ne sera pas modifié tant que vous n'aurez pas cliqué sur le lien.
              </p>
            </td>
          </tr>
        </table>
