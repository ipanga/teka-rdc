...
<head>
  <meta charset="UTF-8">
  <title>Retrait effectué — Teka RDC</title>
</head>
    ...
    <tr>
      <td align="center">
        <table role="presentation" cellpadding="0" cellspacing="0" style="max-width:560px;width:100%;background:#ffffff;border-radius:8px;padding:40px;">
          <tr>
            <td>
              <h1 style="margin:0 0 16px 0;font-size:22px;color:#111827;">Retrait effectué 🎉</h1>
              <p style="margin:0 0 16px 0;color:#374151;line-height:1.6;">${greeting}</p>
              <p style="margin:0 0 16px 0;color:#374151;line-height:1.6;">
                Votre retrait de <strong>${amountLabel}</strong> a été effectué vers votre compte mobile money.
              </p>
              ...
              <p style="margin:0;color:#6b7280;font-size:13px;line-height:1.6;">
                Si vous ne recevez pas le paiement, contactez le support avec la référence ci-dessus.
              </p>
            </td>
          </tr>
        </table>
