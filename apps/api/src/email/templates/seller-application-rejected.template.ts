...
<head>
  <meta charset="UTF-8">
  <title>Votre demande vendeur — Teka RDC</title>
</head>
    ...
    <tr>
      <td align="center">
        <table role="presentation" cellpadding="0" cellspacing="0" style="max-width:560px;width:100%;background:#ffffff;border-radius:8px;padding:40px;">
          <tr>
            <td>
              <h1 style="margin:0 0 16px 0;font-size:22px;color:#111827;">Votre demande vendeur n'a pas été approuvée</h1>
              <p style="margin:0 0 16px 0;color:#374151;line-height:1.6;">${greeting}</p>
              <p style="margin:0 0 16px 0;color:#374151;line-height:1.6;">
                Après examen, votre demande de compte vendeur sur Teka RDC n'a pas pu être approuvée pour le moment.
              </p>
              <p style="margin:0 0 8px 0;color:#374151;line-height:1.6;"><strong>Motif :</strong></p>
              <p style="margin:0 0 24px 0;padding:12px 16px;background:#fef2f2;border-radius:6px;color:#991b1b;line-height:1.6;">
                ${reason}
              </p>
              <p style="margin:0 0 24px 0;color:#374151;line-height:1.6;">
                Vous pouvez corriger les informations concernées et soumettre à nouveau votre demande.
              </p>
              <table role="presentation" cellpadding="0" cellspacing="0" style="margin:0 0 24px 0;">
                <tr>
                  <td style="border-radius:6px;background:#BF0000;">
                    <a href="${applyUrl}" style="display:inline-block;padding:12px 24px;color:#ffffff;text-decoration:none;font-weight:600;">Soumettre à nouveau</a>
                  </td>
                </tr>
              </table>
