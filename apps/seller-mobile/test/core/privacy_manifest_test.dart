...
///
/// Mirrors the buyer-mobile guard (Rule 3: keep both apps in sync). Added with
/// buyer-mobile's 5.1.2(i) rejection so seller-mobile never ships a manifest
/// that claims tracking it does not do — the two apps share the same Sentry +
/// PostHog + FCM stack and the same "no ad SDK, no data broker" posture.
///
