# Status — 2026-09-11 (production `main` `57d7dc2`; `develop` `8dbf837`, synchronized. **The 2026-09-10 taxonomy initiative is COMPLETE — all three relationships now materialised in production.** Categories + 2 product moves + deodorant dedup (`2026-09-10_taxonomy_milk_alcohol_deodorant.sql`, deployed 2026-09-10); **characteristics CLOSED** (`2026-09-10_taxonomy_attribute_backfill.sql`, `product_attributes` 560 → 584, verified live); **brand links CLOSED** (`2026-09-11_taxonomy_brand_links.sql`, `brands` 51 → 55, `brand_categories` 314 → 326, verified live — all six leaves return their intended brands via `/v1/brands?categoryId=`, historical rows 50/51 untouched, 0 products or orders mutated). Store release automation available for both platforms: **iOS TestFlight** and **Android Google Play** (#745, `android-play` approval gate, internal track). ## Active initiative: None — next work is the P3 taxonomy/data-quality backlog, not started.)
